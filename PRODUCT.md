...
A single-page portfolio (React + Vite, deployed on Vercel at harshavardhanag.com) that mirrors and expands his resume: featured project (Towinly), more projects, experience, skills, coursework, and a personal "Beyond Code" section. Success = a recruiter contacts him or opens a project's live demo/GitHub.
