...
export default function Contact() {
  const { email, phone, linkedin, github, instagram } = profile.contact;
    ...
    <section id="contact" className="px-6 py-20">
      <div className="mx-auto max-w-[1100px]">
        ...
        <p className="mb-8 max-w-xl text-gray-600 dark:text-gray-300">
          I&rsquo;m open to full-time and part-time opportunities. Feel free to
          reach out.
        </p>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 rounded-lg border border-[#0A66C2] px-5 py-3 text-sm font-medium text-[#0A66C2] transition-colors hover:bg-[#0A66C2] hover:text-white dark:border-[#0A66C2] dark:text-[#0A66C2] dark:hover:bg-[#0A66C2] dark:hover:text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
