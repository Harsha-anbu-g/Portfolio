      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 5%" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "3rem" }}>
          {profile.coursework.map((sem, si) => {
            const color = semesterColors[sem.semester] || "#0EA5E9";
            return (
              <div key={si}>
                {/* Semester label */}
                <div style={{
                  ...
                  {sem.courses.map((course, ci) => (
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${sem.current ? "rgba(14,165,233,0.2)" : "rgba(0,0,0,0.08)"}`,
                        borderRadius: "4px",
                        background: sem.current ? "rgba(14,165,233,0.03)" : "#fafaf9",
                      ...
                      onMouseLeave={e => {
                        e.currentTarget.style.borderColor = sem.current ? "rgba(14,165,233,0.2)" : "rgba(0,0,0,0.08)";
